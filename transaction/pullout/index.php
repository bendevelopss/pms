...
<button type="button" name="btnNext" onclick="return myFunctions();" class="btn btn-primary">Accept Request</a></button>
<button type="submit" name="btnDec" onclick="return done();" class="btn btn-danger">Decline Request</a></button>
</div>
