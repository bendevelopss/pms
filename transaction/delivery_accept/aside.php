<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview"><a href="../../home/ongoing/index.php"><i class="glyphicon glyphicon-home"></i> <span>Home</span></a></li>             
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li class="active"><a href="../../utilities/restorematerials/index.php"><i class="fa fa-circle-o"></i>Restore Materials</a></li>


        </ul>
      </li>
      <li class="treeview"><a href="#"><i class="fa fa-book"></i> <span>Reports</span></a></li>
      <li class="treeview"><a href="../../utilities/inventory/index.php"><i class="fa fa-cubes"></i> <span>Inventory</span></a></li>
