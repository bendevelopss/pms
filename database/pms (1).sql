...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2017 at 06:49 AM
...
('2017-12-16 05:31:05', 'admin', 'Updated Billing Record:Doe, John .->Escobinas, Carmina'),
('2017-12-16 05:31:09', 'admin', 'Updated Billing Record:Doe, John .->Escobinas, Carmina'),
('2017-12-16 05:31:11', 'admin', 'Updated Billing Record:Doe, John .->Escobinas, Carmina'),
('2017-12-16 05:31:13', 'admin', 'Updated Billing Record:Doe, John .->Escobinas, Carmina'),
('2017-12-16 05:31:17', 'admin', 'Updated Billing Record:blank->Escobinas, Carmina'),
('2017-12-16 05:31:19', 'admin', 'Updated Billing Record:Doe, John .->Escobinas, Carmina'),
('2017-12-16 05:31:22', 'admin', 'Updated Billing Record:blank->Escobinas, Carmina'),
('2017-12-16 05:31:39', 'admin', 'Updated Billing Record:Santos, Antonio C.->Beltran, Eunice S.'),
('2017-12-16 05:31:42', 'admin', 'Updated Billing Record:Santos, Antonio C.->Beltran, Eunice S.'),
('2017-12-16 05:31:44', 'admin', 'Updated Billing Record:Santos, Antonio C.->Beltran, Eunice S.'),
('2017-12-16 05:31:46', 'admin', 'Updated Billing Record:Santos, Antonio C.->Beltran, Eunice S.'),
('2017-12-16 05:31:49', 'admin', 'Updated Billing Record:blank->Beltran, Eunice S.'),
('2017-12-16 05:32:57', 'admin', 'Restored Employee Record'),
('2017-12-16 05:33:15', 'admin', 'Updated Employee Record:Nieva->test'),
('2017-12-16 05:33:20', 'admin', 'Updated Employee Record:caban->test'),
('2017-12-16 05:33:30', 'admin', 'Updated Employee Record:lyka->celeena'),
('2017-12-16 05:33:59', 'admin', 'Updated Employee Record:faker->user1'),
('2017-12-16 05:34:05', 'admin', 'Updated Employee Record:sample data->samp'),
('2017-12-16 05:34:10', 'admin', 'Updated Employee Record:faker->samp'),
('2017-12-16 05:34:13', 'admin', 'Updated Employee Record:faker->samp'),
('2017-12-16 05:34:22', 'admin', 'Updated Employee Record: feke->blank'),
('2017-12-16 05:36:35', 'admin', 'Updated Payment Record:Doe, John .->Escobinas, Carmina'),
('2017-12-16 05:36:38', 'admin', 'Updated Payment Record:Doe, John .->Escobinas, Carmina'),
('2017-12-16 05:36:40', 'admin', 'Updated Payment Record:Doe, John .->Escobinas, Carmina'),
('2017-12-16 05:36:43', 'admin', 'Updated Payment Record:Doe, John .->Escobinas, Carmina'),
('2017-12-16 05:36:57', 'admin', 'Updated Position Record:Ehems->user'),
('2017-12-16 05:42:18', 'admin', 'Added Position Record'),
('2017-12-16 05:46:56', 'admin', 'Updated Billing Record:fareal->Persan');
...
(2, 'carlito', 'admin', 'Carl', 'Abra', 'Kalabaw', 'Foreman', '09489338914', 'edni@gmail.com', 'Sta. Ana', 'Manila', 'active'),
...
(1, 'Supplier 1', '123456789', '6546846546', 'supplier1@yahoo.com', 'test', 'test', 'test', '09236873123', 'Maginhawa', 'Negros', 'active'),
