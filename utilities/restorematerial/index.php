                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                      <div class="box box-solid">
                        <div class="box-header">
                          <h3 class="box-title">Inactive Materials</h3>
...
// Check connection
                              ...
                              <form action="" method="post">
                                <?php
                                $sql = " select * from materials where status='inactive' group by material_no";
                                ...
                                { 
                                  ...
                                  ?>
                                  <td style="text-align:center"><button type="submit" name="btnRemove" value="<?php echo''.$material_no.''; ?>"   onclick="return confirm('Are you sure?');"> Restore</button>
                                    ...
                                    if(isset($_POST['btnRemove'])) {
                                     ...
                                     echo '<script type="text/javascript">alert("Material has been restored")</script>'; 
