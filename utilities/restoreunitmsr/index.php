...
<head>
  <meta charset="UTF-8">
  <title>Restore Unit of Measurement</title>
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                      <div class="box box-solid">
                        <div class="box-header">
                          <h3 class="box-title">Inactive Unit of Measurement</h3>
...
// Check connection
                              ...
                              <form action="" method="post">
                                <?php
                                $sql = " select * from unitmeasurement where status='inactive' group by unit_no";
                                ...
                                { 
                                  ...
                                  ?>
                                  <td style="text-align:center"><button type="submit" name="btnRemove" value="<?php echo''.$unit_no.''; ?>"   onclick="return confirm('Are you sure?');"> Restore</button>
                                    ...
                                    if(isset($_POST['btnRemove'])) {
                                     ...
                                     echo '<script type="text/javascript">alert("Unit Measurement has been restored")</script>'; 
