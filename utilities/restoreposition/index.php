...
// Check connection
                              ...
                              <form action="" method="post">
                                <?php
                                $sql = " select * from position where status='inactive' group by position_no";
                                ...
                                { 
                                  ...
                                  ?>
                                  <td style="text-align:center"><button type="submit" name="btnRemove" value="<?php echo''.$position_no.''; ?>"   onclick="return confirm('Are you sure?');"> Restore</button>
                                    ...
                                    if(isset($_POST['btnRemove'])) {
                                     ...
                                     echo '<script type="text/javascript">alert("Position has been restored")</script>'; 
