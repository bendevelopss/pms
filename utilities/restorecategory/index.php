                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                      <div class="box box-solid">
                        <div class="box-header">
                          <h3 class="box-title">Inactive Category</h3>
...
// Check connection
                              ...
                              <form action="" method="post">
                                <?php
                                $sql = " select * from category where status='inactive' group by category_no";
                                ...
                                { 
                                  ...
                                  ?>
                                  <td style="text-align:center"><button type="submit" name="btnRemove" value="<?php echo''.$category_no.''; ?>"   onclick="return confirm('Are you sure?');"> Restore</button>
                                    ...
                                    if(isset($_POST['btnRemove'])) {
                                     ...
                                     mysql_query("update category set status='".$status."' 
                                      where category_no=".$nos);
                                     echo'<div class="bottom">';
                                     echo '<script type="text/javascript">alert("Category has been restored")</script>'; 
                                     echo "<meta http-equiv='refresh' content='0'>";
                                   }
