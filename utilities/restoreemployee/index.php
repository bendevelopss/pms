                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                      <div class="box box-solid">
                        <div class="box-header">
                          <h3 class="box-title">Inactive Employee</h3>
...
// Check connection
                              ...
                              <form action="" method="post">
                                ...
                                { 
                                  ...
                                  ?>
                                  <td style="text-align:center"><button class="btn btn-primary" type="submit" name="btnRemove" value="<?php echo''.$emp_no.''; ?>"   onclick="return confirm('Are you sure?');"> Restore</button>
