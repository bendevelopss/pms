...
<div class="col-xs-3" id="empnameErDv"> 
  ...
  <input type="text" class="form-control" id="unitname1" name="unitname1" required>
</div>     

<div class="col-xs-2" id="empnameErDv"> 
  <label><font color="darkred">*</font>Unit</label> 
  <select name="abbrev1" id="abbrev1" class="form-control" style="margin-left: -20px" required>
   <?php
