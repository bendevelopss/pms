                                    ...
                                    <div class="col-xs-4" id="addErDv"> 
                                      <label><font color="darkred">*</font>Employee ID</label> <!-- Prod_Name -->
                      ...
                      echo'<option value="'.$position_name.'">'.$position_name.'</option>';
                            ...
                            echo'</select>';?>
                                    ...
                                    <div class="col-xs-4" id="phoneErDv"> 
                                      ...
                                      <input type="number" class="form-control" name="contact1" id="contact1" data-inputmask='"mask": "9999-999-9999"' data-mask >
                                    </div>    
