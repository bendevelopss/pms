          ...
          <li class="dropdown user user-menu">
           ...
           <ul class="dropdown-menu">
            ...
            <li class="user-header">
              ...
              <img src="<?php echo 'image/'.($image).''; ?>" class="img-circle">
              <p>
...
// Check connection
                        ...
                        {  
                         ...
                         echo '<tr>'; 
                         echo'<td style=" display:block; width:12%; height:auto;"><img style="width:60px; height:60px;" src="image/'.($row['image']).'"></td>';
              ...
              <div class="modal-content" >
                ...
                <div class="modal-body" >
                  ...
                  <div class="row" style="margin-bottom:5px"> <!-- ROW 1 -->
                    <div class="col-xs-3" id="emailErDv"> 
                      <label><font color="darkred">*</font>Image</label> <!-- Prod_Name -->
                      <input type="file" name="txtimage" id="txtimage" required>
                    </div> 
      ...
      <div id="editModal" class="fade modal" >
        <form name="formCust" method="post" action="">
          <div class="modal-dialog">
            <div class="modal-content" >
              <div class="modal-header">
                <button type="butt on" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    ...
    <script type="text/javascript">
      function get_id(o) {
        ...
        $emp_no1.val(getid);  
        $emp_no1 = $modal.find('#emp_no1');
        $emp_no1.val(document.getElementById("jsontable").rows[($(o).parent().parent().index())+1].cells[1].innerHTML);   

        $firstname1 = $modal.find('#firstname1');
        $firstname1.val(document.getElementById("jsontable").rows[($(o).parent().parent().index())+1].cells[2].innerHTML);
        $middlename1 = $modal.find('#middlename1');
        $middlename1.val(document.getElementById("jsontable").rows[($(o).parent().parent().index())+1].cells[3].innerHTML);
        $lastname1 = $modal.find('#lastname1');
        $lastname1.val(document.getElementById("jsontable").rows[($(o).parent().parent().index())+1].cells[4].innerHTML);
        $pname1 = $modal.find('#pname1');
        $pname1.val(document.getElementById("jsontable").rows[($(o).parent().parent().index())+1].cells[5].innerHTML); 
        $contact1 = $modal.find('#contact1');
        $contact1.val(document.getElementById("jsontable").rows[($(o).parent().parent().index())+1].cells[6].innerHTML);
        $email1 = $modal.find('#email1');
        $email1.val(document.getElementById("jsontable").rows[($(o).parent().parent().index())+1].cells[7].innerHTML);
        $username1 = $modal.find('#username1');
        $username1.val(document.getElementById("jsontable").rows[($(o).parent().parent().index())+1].cells[8].innerHTML);
        $street1 = $modal.find('#street1');
        $street1.val(document.getElementById("jsontable").rows[($(o).parent().parent().index())+1].cells[9].innerHTML);
