...
$row=mysql_fetch_array($content2);
	...
	$this->Text(145,37,'Quotation No.',0,0,'l');
	$this->SetFont('Arial','u',11);
	$this->Text(170,37,''.$_GET['quote_no'].'',0,0,'l');
    ...
    $this->Text(90,54,'Quotation',0,0,'C');
	  $this->Ln(10); 
	  $this->SetFont('Arial','B',11);
...
$this->Text(174,68,''.$_SESSION['date'].'',0,0,'C');
	$this->SetFont('Arial','',11);
		$this->Text(148,74,'Address :',0,0,'C');
		$this->SetFont('Arial','u',11);
$this->Text(165,74,''.$row['address'].'',0,0,'C');
	$this->SetFont('Arial','u',11);
	$this->Ln(10); 
}
